---
title: "Whisper Large v3 (OpenAI)"
description: "High-accuracy multilingual speech recognition and translation model optimized for challenging audio and long-form transcription."
---

## Model Quickstart

This section helps you quickly get started with the `Whisper Large v3` model on the Qubrid AI inferencing platform.
...
Once authenticated with your API key, you can send inference requests to the `Whisper Large v3` model and receive responses based on your input prompts.
...
func main() {
	...
	_ = writer.WriteField("model", "openai/whisper-large-v3")
